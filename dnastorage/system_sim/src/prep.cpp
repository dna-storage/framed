...
#include "sequencer.h"
#include <stdlib.h>
prep_unit_t::prep_unit_t(unsigned long timer, unsigned long num_channels) : system_unit_t(timer,num_channels){}

//constructor for the prep component of the system
prep_t::prep_t(unsigned long timer, unsigned long num_channels, unsigned long buffer_size,unsigned long num_preps,list_entry_t* prep_seq_buffer,system_sim_t* _system,system_storage_t* dna_storage){
